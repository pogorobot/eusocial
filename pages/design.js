...
export default function Design() {
  return (
    <div>
      <h1>DESIGN</h1>
      <p>Eusocial is meant to help you be a social creature.</p>
      <p>There are as many ways to be a social creature as there are creatures in societies.</p>
      <p>Where c is the total number of creatures, and s is the total number of societies,</p>
      <p>The ways to be a social creature may be represented as sc</p>
      <p>The ways to help a social creature be helpful may then be (sc)^2, social creatures squared</p>
